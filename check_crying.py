...
PATH = r"C:\Users\Angela\Documents\CMU\F18\18-500\data_crying\\"
# cwd = os.getcwd()

FILENAME = "baby-crying-01.wav"
THRESHOLD = 200  # THRESHOLD definitely can be greater than 7

def check_crying(accData, sampling_per_sec):
...
# [sampling_rate, data] = wavfile.read(PATH+FILENAME)

waveFile = wave.open(PATH+FILENAME, 'r')
length = waveFile.getnframes()
print(waveFile.readframes(length))
print("framerate = " + str(waveFile.getframerate()))
